...
public class TelaMostrarDados extends javax.swing.JFrame {
	...
	public void gerarLSCC() {
		...
		int x =  lscc.get(0).pesoModificaÁ„o;
		...
		for (int i = 0; i < lscc.size(); i++) {
            ...
            tabelaLSCC.setValueAt(c.pesoModificaÁ„o, i, 1);
           vetorLscc[c.pesoModificaÁ„o]++;
		}
	...
	public void gerarIN() {
		...
		for (int i = 0; i < in.size(); i++) {
            ...
            tabelaIN.setValueAt(in.get(i).pesoModificaÁ„o, i, 1);
		}
	...
	public void gerarOUT() {
		...
		for (int i = 0; i < out.size(); i++) {
            ...
            tabelaOUT.setValueAt(out.get(i).pesoModificaÁ„o, i, 1);
		}		
	}
	...
	public void gerarTUBES() {
		...
		for (int i = 0; i < tubes.size(); i++) {
            ...
            tabelaIN.setValueAt(tubes.get(i).pesoModificaÁ„o, i, 1);
		}
	...
	public void gerarTENDRILS() {
		...
		for (int i = 0; i < tendrils.size(); i++) {
            ...
            tabelaTENDRILS.setValueAt(tendrils.get(i).pesoModificaÁ„o, i, 1);
		}
	}
	...
	public void gerarDISCONNECTED() {
		...
		for (int i = 0; i < disconnected.size(); i++) {
            ...
            tabelaDISCONNECTED.setValueAt(disconnected.get(i).pesoModificaÁ„o, i, 1);
		}
